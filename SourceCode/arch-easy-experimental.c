...
static const char *APP_CSS =
    ...
    "button, button * { background-color: #21262d; }"
    "button.suggested-action, button.suggested-action * { background-color: #1f6feb; }"
    "button.destructive-action, button.destructive-action * { background-color: #da3633; }"
    "button.large-option, button.large-option * { background-color: #21262d; }"
    "button.large-option.selected { background-color: #1c2128; }"
    "scrolledwindow, viewport { background-color: #0d1117; }"
    ...
    "searchbar, searchentry { background-color: #0d1117; border-color: #30363d; }"
    "spinner { color: #58a6ff; }"
    "tooltip { background-color: #21262d; color: #c9d1d9; border: 1px solid #30363d; }"
    "tooltip * { background-color: #21262d; color: #c9d1d9; }"
    "dialog { background-color: #0d1117; }"
    "dialog > box { background-color: #0d1117; }"
    "dialog .dialog-action-area { background-color: #161b22; border-top: 1px solid #30363d; }"
    ".message-dialog-text, .message-dialog-secondary-text { color: #c9d1d9; }"
    "box { background-color: transparent; }"
    "grid { background-color: transparent; }"
    "stack { background-color: #0d1117; }"
